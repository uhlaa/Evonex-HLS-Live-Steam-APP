...
import 'package:chewie/src/material/live_badgep.dart';
...
class _MaterialControlsState extends State<MaterialControls>
  ...
  Timer? _hideTimer;
  Timer? _initTimer;
  late Duration _subtitlesPosition = Duration.zero;
  ...
  /// Direct PiP button – no bottom sheet, no options
  Widget _buildPiPButton() {
    return AnimatedOpacity(
      ...
      child: IconButton(
        ...
        icon: const Icon(Icons.picture_in_picture_alt, size: 22, color: Colors.white),
      ),
    );
  }
